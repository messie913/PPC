...
<body>
    ...
    <main class="container-fluid">
            <section class="contact mb-5 px-5">
                <div class="contactText w-100" >
                    <h5 class="display-5 text-success">Contactez-nous</h5>
                    <p>Besoin d'aide ou d'informations supplémentaires? N'hésitez pas à nous contacter via le formulaire ci-dessous.</p> 
                    <?php
                        //Affichage message erreur
                        if (isset($_GET["error"])) {
                            if($_GET["error"] == "noname"){
                                echo '<p class="error">*Le champ nom ne peut pas être vide. Veuillez saisir un nom.</p>';
                            }
                            if($_GET["error"] == "noemail"){
                                echo '<p class="error">*Le champ email ne peut pas être vide et doit être valide. Veuillez saisir un email valide.</p>';
                            }
                            if($_GET["error"] == "nophone"){
                                echo '<p class="error">*Le champ téléphone ne peut pas être vide. Veuillez saisir un numéro de téléphone valide.</p>';
                            }
                            if($_GET["error"] == "nomessage"){
                                echo '<p class="error">*Le champ message ne peut pas être vide. Veuillez saisir un message.</p>';
                            }
                        }
                    ?>
                    <form action="../_Bend/_sub_forms/submit_formContact.php" method="post" id="frmContact">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="telHelp" class="form-text">Nous ne partagerons pas votre email avec une tierce personne ou compagnie.</div>
                        </div>
                        <div class="mb-3">
                            <label for="texte" class="form-label">Message * :</label>
                            <textarea type="text" name="texte" id="texte" class="form-control" required></textarea>
                        </div>
                        <div class="g-recaptcha" id="captchaV" data-sitekey="6Lc-yH8qAAAAAOSKDQ1BsyXW3tajN_nkGQU5gp5z"></div>
                        <div class="mb-3">
                            <button type="submit" name="submitform" id="submitform" class="btn btn-success">Envoyer le formulaire</button>
                        </div>
                    </form>                   
                </div>

                <figure class="contactImg  w-100" id="imgContact">
                    <img src="../_images/pharmacist-work.jpg" alt="image contact"  class="img-fluid border rounded">
                </figure>
            </section>
    </main>
    <footer class="py-3">

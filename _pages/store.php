<?php
    ...
    $res = $conn -> query($sql);
    $produits =[];
    while ($line = $res -> fetch_all()){
        $produits = $line;
    }*/
    //print_r($produits);
    //print_r($res_data); 
    $productId = $produits[0];
    //Traitement filtre 
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="container-fluid">
            ...
            <?php
                if(isset($_GET['error'])){
                    if($_GET['error'] == 'addsuccess'){
                      ...
                      if($_GET['error'] == 'invalidmaxprice'){
                        echo "<p class='error text-center'>Erreur dans le filtre de triage. Le montant maximal doit être supérieur au montant minimal !</p>";
                        echo "
                        <script>
                            //Rafraichir page et nettoyer URL
                            setTimeout( function(){
                    ...
                    <form action="filterbycat.php" method="get" id="product-filter">
                        ...
                        <div class="input-group mb-5">
                           ...
                           <select name="inputGroupSort" id="inputGroupSort" class="form-select">
                                <option selected value="">-- Trier par prix --</option>
                ...
                <?php foreach($produits as $produit): ?>
                            ...
                            <div class="product border card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text h6"><b>Code catégorie : <?= htmlspecialchars($produit[5]); ?></b></h6>
                                    ...
                                    <p class="card-text"><strong>Prix : </strong><?php echo htmlspecialchars($produit[3]);  ?> <strong>FCFA</strong></p>
                                        <div class="favoris d-flex flex-row justify-content-between">
                                            ...
                                            <button 
                                                ...
                                                style=" color: <?= $favorite ? 'green' : 'gray' ?>;"
                                            >
        ...
        <div class="modale" id="modale">
            <div class="modale-content">
                ...
                <h2 class="h2" id="modale-title"></h2>
                <img src="" id="modale-image" alt="Image du produit" class="card-img-top image_card img-fluid">
                <p id="modale-description" class="desc mt-3"></p>
                <p><strong>Prix :</strong><span id="modale-price"></span>FCFA</p>
            </div>
        </div>
    </main>
    <footer class="py-3">

<?php
    ...
    include '_accounts/paginationProduit.php';
    $categorie = $_POST["categorie"];
    $sql = 'SELECT id_produit, nom, description_p, prix,categorie FROM produits WHERE categorie =? ORDER BY id_produit DESC'; 
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse menuComputer" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-lg-1">
                        ...
                        <li class="nav-item mx-lg-4">
                            <a href="store.php" class="nav-link active">Boutique</a>
                        </li>
                        <li class="nav-item mx-lg-4">
    ...
    <main class="container-fluid">
        ...
        <section class="bestventes">
            ...
            <p class="mx-lg-5 my-3">Vous avez sélectionné la catégorie : <?= $categorie; ?></p>
            <div class="containProduct mb-5">
                ...
                <!--<div class="product border card">
                    ...
                    <div class="card-body">
                        <h5 class="h5 card-title">Parfum Flexi</h5>
                        <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vel, neque perferendis! Qui aut temporibus id aliquid. Corrupti sunt soluta cumque, officiis similique sequi! Aspernatur aliquid expedita est, reiciendis quidem nostrum!</p>
                        <div class="favoris">
                ...
                <div class="product border card">
                    <img src="../_images/spa-arrangement-with-cremes.jpg" alt="SPA PDC" class="card-img-top image_card">
                    <div class="card-body">
                        <h5 class="h5 card-title">Creme SPA</h5>
                        <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vel, neque perferendis! Qui aut temporibus id aliquid. Corrupti sunt soluta cumque, officiis similique sequi! Aspernatur aliquid expedita est, reiciendis quidem nostrum!</p>
                        <div class="favoris">
                            <a href="#" class="btn btn-primary">Ajouter au panier</a>
                            <button class="btn">
                ...
                <div class="product border card">
                    <img src="../_images/close-up-bottles-with-oil-pills-table.jpg" alt="Parfum PDC" class="card-img-top image_card">
                    <div class="card-body">
                        <h5 class="h5 card-title">Parfum Flexi</h5>
                        <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vel, neque perferendis! Qui aut temporibus id aliquid. Corrupti sunt soluta cumque, officiis similique sequi! Aspernatur aliquid expedita est, reiciendis quidem nostrum!</p>
                        <div class="favoris">
                ...
                <div class="product border card">
                    <img src="../_images/myriam-zilles-KltoLK6Mk-g-unsplash.jpg" alt="Parfum PDC" class="card-img-top image_card">
                    <div class="card-body">
                        <h5 class="h5 card-title">Pillule Flexi</h5>
                        <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vel, neque perferendis! Qui aut temporibus id aliquid. Corrupti sunt soluta cumque, officiis similique sequi! Aspernatur aliquid expedita est, reiciendis quidem nostrum!</p>
                        <div class="favoris">
                            <a href="#" class="btn btn-primary">Ajouter au panier</a>
                            <button class="btn">
                ...
                <!--Ajout dynamique-->              
                    <?php foreach($produits as $produit): ?>
                        <div class="product border card" >
                                    ...
                                    ?>
                                    <?php if(!empty($images)): ?>
                                        <img onclick="showProduct(<?php echo $produit[0]; ?>)" src="/Parapharmacie_du_congo/<?php echo $images[0]['image_p']; ?>" alt="Image principale" class="card-img-top image_card">
                                    <?php else: ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-text h6"><b>Code catégorie : <?= htmlspecialchars($produit[4]); ?></b></h6>
    ...
    <a href="../_Bend/_sub_forms/uploads/"></a>

...
<body>
    <header class="mb-5">
        ...
        <main class="mb-5 ">
            <h1 class="display-5 text-success text-center mb-5">🛒 Oops votre panier est vide !</h1>
            <?php
                if(isset($_GET['error'])){
            ...
            ?>
            <p>Vous n’avez pas encore ajouté de produits à votre panier.
            Parcourez notre boutique et trouvez les articles qui vous plaisent !</p>
            <p>Profitez de livraison rapide, paiement sécurisé et satifaction garantie.</p>
            <p>Une question ? Notre service client est là pour vous.</p>
            <a href="../store.php" class="btn btn-success mt-2 mb-4">Retourner à la boutique</a>
            <table class="table">
                <thead>
                    <tr>
                        <th>Article</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="modifQtePanier.php" method="post">
                                    <input type="hidden" name="id" value="<?= $produit['id_produit']; ?>" style="width: 20%;">
                                    <input type="number" name="quantite" value="<?= $_SESSION['panier'][$produit['id_produit']]; ?>" min="1" style="width: 20%;">

    ...
    <?php if(isset($_SESSION['userId'])): ?>
        <nav class="mb-3 mx-2 mx-lg-5" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Mes produits favoris</li>
                </ol>
        </nav>
        <main class="container-fluid m-auto container mb-5">
            <h1 class="text-success text-center">Mes produits favoris</h1>
            <P>Retrouvez la liste complète de vos produits favoris.</P>
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <?php
                                        ...
                                        ?>
                                        <?php if(!empty($images)): ?>
                                            <img src="../../Parapharmacie_du_congo/<?= $images[0][0]; ?>" alt="Image principale" class="img-fluid image_card cardImages">
                                        <?php else: ?>
                                        <?php endif; ?>
                                </td>
                                <td><?= $favorite["nom"]; ?></td>
                                <td><?= $favorite["prix"]; ?> FCFA</td>

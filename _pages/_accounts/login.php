...
<body class="container-fluid">
    ...
    <main>
        <h1 class="display-5 text-success text-center">Ouvrir une session - Parapharmacie du Congo </h1><br>
                
                <section class="txtLogin w-75 mb-5 m-auto">
                <form action="../../_Bend/_sub_forms/submit_formlogin.php" method="post">
                        <div class="">
                            
                            <p>Vous êtes administrateur ? <a href="adminLogin.php">Connecter vous ici</a></p>
                            <p>Veuillez remplir le formulaire suivant pour accéder à votre profil.</p>
                        <!--Error message-->
                        <?php
                            if(isset($_GET["error"])){
                                if($_GET["error"] == "wrongpassword"){
                                    echo '<p class="error">Le mot de passe que vous avez entrer n\'est pas correcte. Veuiller entrer un mot de passe valide.</p>';
                                    echo "
                                    <script>
                                ...
                                if($_GET["error"] == "usernamedontexist"){
                                    echo '<p class="error">Le nom d\'utilisateur saisi n\'existe pas. Veuiller entrer un nom d\'utilisateur valide</p>';
                                    echo "
                                    <script>
                                       //Rafraichir page et nettoyer URL
                                       setTimeout( function(){
                                ...
                                if($_GET["error"] == "entercredentials"){
                                    echo '<p class="error">Veuiller entrer un nom d\'utilisateur et mot de passe valide.</p>';
                                    echo "
                                    <script>
                                       //Rafraichir page et nettoyer URL
                                       setTimeout( function(){
                                ...
                                if($_GET["error"] == "connectionneed"){
                                    echo '<p class="error">Veuiller svp vous connecter à votre compte pour valider votre commande. Merci</p>';
                                    echo "
                                    <script>
                                       //Rafraichir page et nettoyer URL
                                       setTimeout( function(){
                        ...
                        ?>
                            ...
                            <div class="mb-1">
                                <button type="submit" name="submit_Login" id="submit_Login" class="btn btn-success">Ouvrir une session</button>
                            </div>  
                            <div class="my-3">
                                <p>Vous n'avez pas de compte ? <a href="signup.php">Créer un compte</a></p> 
                            </div>
                            <div class="mb-1">
                                <p class="mt-3">Vous avez oublié votre mot de passe ? <a data-bs-toggle="offcanvas" href="#offcanvasPWD" role="button" aria-controls="offcanvasExample">Réinitialisez-le</a></p>
                            </div>  
                            <div class="offcanvas offcanvas-start" data-bs-scroll="true"  tabindex="-1" id="offcanvasPWD" aria-labelledby="offcanvasExampleLabel">
                                <div class="offcanvas-header">
                                    <h5 class="offcanvas-title" id="offcanvasExampleLabel">🔐 Réinitialisation du mot de passe</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                </div>
                                <div class="offcanvas-body">
                                    <div>
                                        <p>Pour des raisons de sécurité, la réinitialisation de votre mot de passe ne peut pas être effectuée automatiquement.</p>
                                        <p><strong>👉 Veuillez contacter notre support technique</strong> pour obtenir de l’aide.</p>
                                          <ul style="list-style: none; padding-left: 0;">
                                            <li>📞 <strong>Téléphone :</strong> +242 06 123 45 67</li>
                                            <li>📧 <strong>Email :</strong> <a href="mailto:mbregiscg@gmail.com">support@ppc.com</a></li>
                                            <li>💬 <strong>WhatsApp :</strong> <a href="https://wa.me/+15146775478" target="_blank">cliquez ici</a></li>
                                        </ul>
                                        <p style="margin-top: 10px;">Notre équipe est disponible pour vous assister.</p>
                                    </div>
                                </div>
                            </div>
                </form>
                <figure class="imgLogin">
                </figure>
                </section>
    </main>
    <footer class="py-3">

<?php
    ...
    $sql = "SELECT nom, description_p,prix,categorie FROM produits WHERE id_produit = ?";
...
<head>
    ...
    <title>Modifier le produit - PPC</title>
      <!--Style pages-->
    ...
    <?php if(isset($_SESSION['id'])): ?>
        <nav class="mb-3 mx-2 mx-lg-5" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="listProducts.php" class=" text-success">Liste des produits</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Modifier un produit</li>
                </ol>
        </nav>
        <main class="container-fluid m-auto mb-5 container">
            <h1 class="h1 text-success text-center">Modifier produit</h1>
            <p>Pour modifier un produit, Veuillez modifier le formulaire suivant :</p>
            <?php
                if(isset($_GET["error"])){
            ...
            ?>
            <form action="../../_Bend/_sub_forms/submitModifProduct.php" method="post" enctype="multipart/form-data">
                <fieldset class="border p-2">
                    <input type="hidden" name="id_produit" value="<?=$id_product; ?>">
                
                    <legend class="float-none w-auto p-2 text-success text-center h5">Informations sur le produit : <span class="error"><?= $produits[0]['nom']; ?></span></legend>
                    <label for="name" class="form-label">Nom du produit :</label>
                    <input type="text" name="name" id="name" class="form-control" value="<?= $produits[0]['nom']; ?>" required><br>
                    <label for="desc" class="form-label">Description du produit :</label>
                    <textarea name="desc" id="desc" class="form-control"  required><?= $produits[0]['description_p']; ?></textarea><br>
                    <label for="prix">Prix du produit :</label>
                    <input type="number" name="prix" step="0.01" id="prix" placeholder="Prix en FCFA" class="form-control" value="<?= $produits[0]['prix']; ?>"  required>
                    <label for="categorie" class="form-label mt-3">Catégorie du produit :</label>
                    <select name="categorie" id="categorie" class="form-select">
                        <option selected><?= $produits[0]['categorie']; ?></option>
                        <option value="sante">Santé</option>
                        <option value="hygiene">Hygiène</option>
                        <option value="bebe">Bébé</option>
                        <option value="electros">Electros</option>
                ...
                <button type="submit" name="modif_produit" id="modif_produit" class="btn btn-success mt-3">Modifier le produit</button>
            </form>
        </main>
    <?php else: ?>

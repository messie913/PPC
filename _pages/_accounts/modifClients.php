<?php
    ...
    $sql = "SELECT username, u_password,nom,email,telephone FROM client WHERE id = ?";
...
<html lang="en">
    <head>
        ...
        <title>Modifier le client - PPC</title>
        <!--Style pages-->
        ...
        <?php if(isset($_SESSION['id'])): ?>
            <nav class="mb-3 mx-2 mx-lg-5" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="listClients.php" class=" text-success">Liste des clients</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Gérer les clients</li>
                </ol>
            </nav>
            <main class="container-fluid m-auto mb-5 container">
                <h1 class="h1 text-success text-center">Modifier compte client</h1>
                <p>Pour modifier le compte client de : <strong class="error"><?= $clients[0]['nom']; ?></strong>, Veuillez modifier le formulaire suivant :</p>
                <?php
                    if(isset($_GET["error"])){
                ...
                ?>
                <form action="../../_Bend/_sub_forms/submitModifClients.php" method="post" id="frmContact">
                        <input type="hidden" name="id_client" value="<?= $id_client; ?>">
                        <label for="nom" class="form-label">Nom et prénom :</label>
                        <input type="text" name="nom" id="nom" class="form-control mb-3" value="<?= $clients[0]['nom'];?>"  required>
                        <label for="telephone" class="form-label">Téléphone :</label>
                        <input type="tel" name="telephone" id="telephone" class="form-control mb-3" value="<?= $clients[0]['telephone']; ?>" required>
                        <label for="email" class="form-label">Email :</label>
                        <input type="email" name="email" id="email" class="form-control mb-3" value="<?= $clients[0]['email']; ?>" required>
                        <label for="username" class="form-label">Nom d'utilisateur :</label>
                        <input type="text" name="username" id="username" class="form-control mb-3" value="<?= $clients[0]['username']; ?>" required>
                        <label for="password" class="form-label">Mot de passe :</label>
                        <input type="password" name="password" id="password" class="form-control mb-3" value="<?= $clients[0]["u_password"]; ?>" required>
                        <label for="password" class="form-label">Confirmer le mot de passe :</label>
                        <input type="password" name="password2" id="password2" class="form-control mb-3" value="<?= $clients[0]["u_password"]; ?>"  required>
                        <div class="mt-5">
                            <button type="submit" name="update_client" id="update_client" class="btn btn-success">Modifier compte client</button>
                        </div>
                </form>
            </main>
        <?php else: ?>

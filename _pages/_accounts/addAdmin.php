...
<head>
    ...
    <title>Ajout nouvel administrateur</title>
      <!--Style pages-->
    ...
    <?php if(isset($_SESSION['id'])): ?>
        <nav class="mb-3 mx-2 mx-lg-5" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Ajout administrateur</li>
            </ol>
        </nav>
        <h1 class="h1 text-center text-success mb-5">Ajouter un nouvel administrateur</h1>
        <?php
                if(isset($_GET['error'])){
                    if($_GET['error'] == 'addsucces'){
                        echo "<p class='error text-center'>Nouvel admin ajouté avec succès !</p>";
                        echo "
                        <script>
                    ...
                    if($_GET['error'] == 'invalidusername'){
                        echo "<p class='error text-center'>Le nom d'utilisateur n'est pas valide.</p>";
                        echo "
                        <script>
                            //Rafraichir page et nettoyer URL
                            setTimeout( function(){
                    ...
                    if($_GET['error'] == 'passworddontmatch'){
                        echo "<p class='error text-center'>Les mots de passe saisies sont différents.</p>";
                        echo "
                        <script>
                            //Rafraichir page et nettoyer URL
                            setTimeout( function(){
                    ...
                    if($_GET['error'] == 'usernametaken'){
                        echo "<p class='error text-center'>Le nom d'utilisateur est déja pris.</p>";
                        echo "
                        <script>
                            //Rafraichir page et nettoyer URL
                            setTimeout( function(){
        ...
        ?>
        <main class="container-fluid px-5 mb-5 d-md-flex">
            <div class="formcontain">
                <p>Veuiller remplir le formulaire ci-dessous pour ajouter un nouvel administrateur :</p>
                <form action="../../_Bend/_sub_forms/addnewadmin.php" method="post" id="frmContact">
                    <label for="nom" class="form-label">Nom et prénom :</label>
                    <input type="text" name="nom" id="nom" class="form-control mb-3" required>
                    <label for="telephone" class="form-label">Téléphone :</label>
                    <input type="tel" name="telephone" id="telephone" class="form-control mb-3" required>
                    ...
                    <input type="password" name="password2" id="password2" class="form-control mb-3" required>
                    <div class="mt-5">
                        <button type="submit" name="submit_admin" id="submit_admin" class="btn btn-success">Ajouter un administrateur</button>
                    </div>
                </form>
            </div>
            <div class="imgform img-fluid w-75">
                <img src="../../_images/imgaddadmin.jpg" alt="Image admin" class="img-fluid">
            </div>

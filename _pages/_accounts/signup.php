...
<head>
    ...
    <script src="../../_JS/formVerif.js" defer></script>    
        <style>
            ...
            .imgSub{
                background: url("../../_images/img_sigup.jpg") center no-repeat;
                background-size: 100%;
                width: 100%;
                height: auto;
                border-radius: 3px;
...
<body class="container-fluid">
    ...
    <main>
        <h1 class="display-5 text-success text-center">Créer un compte - Parapharmacie du Congo </h1><br>
            <div class=" txtInsc">
                <p class="">Vous avez déja un compte ? <a href="login.php" >Connectez-vous</a></p> 
                <p>Veuillez remplir le formulaire suivant pour vous inscrire.</p>
                       
                <cite class="error">Les champs avec * sont obligatoires.</cite><br /><br>
                ...
                <?php
                    ...
                    if(isset($_GET["error"])){
                        ...
                        if ($_GET["error"] == "nophone") {
                            echo '<p class="error">*Le champ telephone ne peut pas être vide. Veuillez saisir un num de telephone.</p>';
                        }
                        if ($_GET["error"] == "novalidemail") {
                            echo '<p class="error">*Le champ email ne peut pas être vide ou est invalide. Veuillez saisir un email valide.</p>';
                        }
                        if ($_GET["error"] == "invalidusername") {
                            echo '<p class="error">*Le champ nom d\'utilisateur ne peut pas être vide ou est invalide. Veuillez saisir un nom d\'utilisateur valide.</p>';
                        }
                        if ($_GET["error"] == "passworddontmatch") {
                            echo '<p class="error">*Les mots de passe ne peut correspondent pas.</p>';
                        }
                    }
                ?>
            </div>
            <section class="m-auto mb-5 d-flex gap-5 flex-column flex-lg-row formInsc">
                <form action="../../_Bend/_sub_forms/submit_formSignup.php" method="post">
                            <div class="mb-3">
                            ...
                            <div class="mb-1">
                                <button type="submit" name="submit_Signup" id="submit_Signup" class="btn btn-primary">Créer un compte</button>
                            </div>   
                            <p class="mt-3">Vous avez déja un compte : <a href="">Connectez-vous</a></p>        
                </form>
                <figure class="imgSub">
                </figure>
            </section>    

...
<head>
    ...
    <title>Connexion admin - PPC</title>
     <!--Style pages-->
    ...
    <!--<script src="../../_JS/formVerif.js" defer></script>--> 
        <style>
            ...
            .imgadmLogin{
                background: url("../../_images/admin.jpg") center no-repeat;
                background-size: 70%;
                width: 100%;
                border-radius: 2%;
            }
...
<body class="container-fluid">
    ...
    <main>
        <h1 class="h2 text-success text-center">Ouvrir une session administrateur- Parapharmacie du Congo </h1><br>
                <section class="txtLogin w-75 mb-5 m-auto">
                <form action="../../_Bend/_sub_forms/submit_loginAdmin.php" method="post" id="frmContact">
                        <div class="">
                            <p>En tant qu'administrateur, faites des opérations avancées.</p>
                        ...
                        ?>
                            ...
                            <div class="mb-1">
                                <button type="submit" name="submit_adLogin" id="submit_adLogin" class="btn btn-success">Ouvrir une session</button>
                            </div>  
                            <div class="mb-1">

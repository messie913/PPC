...
<head>
    ...
    <title>Confirmation achat - PPC</title>
     <!--Style pages-->
...
<body class="container-fluid">
    ...
    <main>
        <h1 class="display-5 text-success text-center">🛍️ Merci pour votre commande n° <strong>PPC000<?= $_SESSION['id_commande']; ?></strong> !</h1>
        <section class=" d-lg-flex justify-content-lg-center align-items-centerr">
            <div class="shop w-100 mt-lg-5 p-lg-5 ">
                <p>🙏 Nous vous remercions <strong><?php echo $_SESSION['nom'];  ?></strong> chaleureusement pour votre achat sur notre site ! Le numéro de votre commande est : <strong>PPC000<?= $_SESSION['id_commande']; ?>.</strong></p>
                <p>Nous vous avons transmis le récapitulatif de votre commande par email.</p>
                <p>Un membre de notre équipe vous contactera le plus rapidement au numéro <strong><?= $_SESSION['telephone']; ?></strong> afin de confirmer les modalités de livraison.</p>
                <p>Vous pouvez confirmer votre commande directement par WhatsApp en cliquant sur le bouton ci-dessous.</p>
                <a class="mb-3" href="https://wa.me/+242057458622?text=Bonjour%2C%20je%20viens%20de%20passer%20une%20commande%20sur%20Parapharmacie%20du%20Congo%20(PPC000<?php echo $_SESSION['id_commande']; ?>)" 
                    target="_blank"
                    ...
                    </svg> Confirmer sur WhatsApp
                </a>

                <p>👉 Commencez votre shopping dès maintenant : <a href="../store.php"> Voir notre boutique</a></p>
            </div>
            <div class="shopImg w-75 h-50 pt-lg-5  m-auto">
                <img src="../../_images/illustration-de-concept-confirmee/2960988.jpg" alt="Image offre inscription" class="img-fluid mt-3 mb-5">
            </div>            
        </section>
    </main>
    <footer class="py-3">

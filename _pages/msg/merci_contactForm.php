...
<body class="container-fluid">
    ...
    <main class="container m-auto  mb-5">
            <h1 class="display-5 text-success text-center">Merci de nous avoir contactés ! ✨ </h1>
            <p class="pt-4">Nous avons bien reçu votre message et nous vous répondrons dans les plus brefs délais. 
            En attendant, n’hésitez pas à parcourir notre boutique et découvrir nos dernières nouveautés. !</p>
            <p>Si vous avez des questions, notre équipe reste à votre disposition.</p>
            <p>À très bientôt ! 😊</p>
            <a href="../store.php" class="btn btn-primary m-auto">Voir notre boutique</a><br><br>
            <figure class="text-center">
                <img src="../../_images/img_offre.webp" alt="Image" class="img-fluid border rounded">
            </figure>

<?php
    ...
    $groupSort = isset($_GET['sort']) ? $conn->real_escape_string($_GET['sort']) : '';
    ...
    $prod_fil = $result ->fetch_all(MYSQLI_NUM);
    print_r($prod_fil);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <main class="container-fluid">
        ...
        <section class="bestventes">
            ...
            <form action="filterbycat.php" method="post" class="d-flex flex-row mx-lg-5 ">
            ...
            <p class="mx-5 my-3">Vous avez sélectionné la catégorie : <?= $categorie; ?></p>
